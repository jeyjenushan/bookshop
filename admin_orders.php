...
include 'admin_header.php';
    ...
    <section class="orders">
            <h1 class="tite">Placed Orders</h1>
           ...
           <div class="box">
            ...
            <p>payment method : <span><?php echo $fetch_orders['method'];?></span></p>
              <form action="" method="post">
                ...
                <a href="admin_orders.php?delete=<?php echo $fetch_orders['id'];?>" onclick="return confirm('delete your order?')" class="delete-btn">DELETE</a>
                          </form>
           </div>
